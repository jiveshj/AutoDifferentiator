...
class Operation(object):
    ...
    def forward(self, *args, **kwargs):
        ...
        ### YOUR CODE HERE ###
        output_variable = Variable(output, parent = self)
        self.child = output_variable
    ...
    def backward(self, downstream_grad):
        ...
        partialDerivatives = self.backward_call(downstream_grad)
        for i, parent in enumerate(parents):
            parent.backward(partialDerivatives[i])
